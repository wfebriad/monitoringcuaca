...
$tekanan = mysqli_query ($connect, "SELECT tekanan FROM cuaca_harian ORDER BY id ASC");
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: 'Tekanan',
                            data: [<?php while ($p = mysqli_fetch_array($tekanan)) { echo '"' . $p['tekanan'] . '",';}?>],
                            backgroundColor: [
                                'rgba(60, 162, 192, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
