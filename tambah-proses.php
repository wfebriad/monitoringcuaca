...
if(isset($_POST['tambah'])){
	...
	$input = mysql_query("INSERT INTO cuaca_harian VALUES(NULL, '$tanggal', '$temperatur', '$tekanan', '$kelembapan', '$temp_max', '$temp_min', '$tek_max', '$tek_min', '$lemb_max', '$lemb_min', '$jumlah')") or die(mysql_error());
	
	
	if($input){
		
		echo '<center><h4>Data cuaca berhasil di tambahkan!';
		echo '<a href="datacuaca.php?halaman=1">  Kembali</a></h4></center>';
		
	}else{
		
		echo '<center><h4>Gagal menambahkan data! ';
		echo '<a href="datacuaca.php?halaman=1">  Kembali</a></h4></center>';
